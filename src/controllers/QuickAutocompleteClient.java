...
public class QuickAutocompleteClient {
    private Scanner input;

    public QuickAutocompleteClient() {
        input = new Scanner(System.in);
    }

    public static void main(String[] args) {
        QuickAutocompleteClient driver = new QuickAutocompleteClient();
        QuickAutocomplete auto = new QuickAutocomplete();
     ...
     */
    private int menu() {
        // Returns integer with selected choice
        System.out.println("-------------------------------------");
    ...
    private void run(QuickAutocomplete auto) {
        int option = menu();
    ...
    /**
     * Returns object to pass through the restricted search method
     */
